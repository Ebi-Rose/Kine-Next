...
**One-pager: How Kine differs from the market**
...
2. **Cookie-cutter programs** that don't adapt to your schedule, equipment, or body
3. **Personal trainers** that cost £200+/month and require fixed schedules

---

## What Kine does differently

Kine is an AI-powered strength training coach built from the ground up for women. It doesn't just log — it programmes, explains, and adapts.

### Core differentiators

| | Kine | Hevy | Strong | JEFIT | Fitbod |
|---|---|---|---|---|---|
...
### Hevy
**What it is:** Workout logging app with social features and routine sharing.
**Who it's for:** People who already know what to do and want to track it.
...
### Strong
**What it is:** Clean, minimal workout tracker focused on logging.
**Who it's for:** Experienced lifters who want a no-frills log.
**Where it falls short for our audience:**
- Pure tracker — zero programming or coaching
- Assumes deep knowledge of exercise selection and periodisation
- No adaptations for cycle, injuries, or experience level
- Limited free tier pushes users to pay just to log
**Kine's advantage:** Kine is a coach, not a notebook. It meets you where you are.

### JEFIT
**What it is:** Exercise database with pre-built plans and community features.
**Who it's for:** Gym-goers who want structure but don't need personalisation.
**Where it falls short for our audience:**
...
### Fitbod
**What it is:** AI-generated workouts based on muscle recovery.
**Who it's for:** People who want variety and don't care about long-term programming.
**Where it falls short for our audience:**
...
## Key messages (for landing page and marketing)
...
- Women in perimenopause looking for adapted programming
- Experienced female lifters who want smarter periodisation
...
| App | Free tier | Paid |
|---|---|---|
| Kine | Private beta (free during beta) | £29.99/mo or £300/yr |
| Hevy | Limited routines, ads | £9.99/mo |
| Strong | 3 routines max | £4.99/mo or £79.99 lifetime |
| JEFIT | Ads, limited plans | £9.99/mo |
| Fitbod | 3 free workouts | £12.99/mo |

**Kine is priced higher because it replaces a coach, not a notepad.** The value prop is programming + coaching + adaptation, not just logging. At ~£1/day, it's a fraction of personal training.

---

*This document is for internal use, landing page copywriting, and investor conversations. Last updated March 2026.*
