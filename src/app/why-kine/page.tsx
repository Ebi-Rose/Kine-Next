    ...
    <div className="wk-page">
      ...
      <div className="wk-container">
        ...
        <div className="wk-founder">
          ...
          <p>My day job is in enterprise architecture, governance, and information security. I&apos;ve spent years building systems where the rules have to hold, the data has to be right, and the decisions have to be explainable. That&apos;s the standard I brought to Kine. Not a side project &mdash; a properly engineered product, built the way serious software should be.</p>
          <p>So I built what I needed. Everything I&apos;ve learned over ten years in the gym and fifteen in technology, shaped by professionals across every discipline this thing required. I&apos;m a working solution to my own problem.</p>
