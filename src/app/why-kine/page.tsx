    ...
    <div className="wk-page">
      ...
      <div className="wk-container">
        ...
        <div className="wk-founder">
          ...
          <p>So I combined everything. My teaching background, my academic work in data science, maths, science and social science, my professional experience in technology and governance &mdash; and everything I&apos;ve learned over ten years in the gym. Shaped by professionals across everything this thing needed &mdash; into a solution myself and others wish we&apos;d had years ago.</p>
