    ...
    <div className="wk-page">
      ...
      <div className="wk-container">
        ...
        <div className="wk-founder">
          ...
          <p>I kept seeing it around me. Women stopping because of conditions nobody was helping them with. Women who wanted to start but didn&apos;t know if they even could. The knowledge was out there, but it was locked behind personal trainers most people can&apos;t afford, or buried in programmes that assumed you had nothing else going on.</p>
          <p>So I built what I needed. Everything I&apos;ve learned over ten years, shaped by professionals across every discipline this thing required. I&apos;m a working solution to my own problem.</p>
