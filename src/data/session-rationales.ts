...
export const SESSION_RATIONALES = {
  'Full Body A': 'You\'re training your whole body today - legs, back, chest, everything. It might sound like a lot but the idea is that each muscle gets a signal to adapt, not that you trash it. Leave a little in the tank and come back next session ready to do more.',
  ...
  'Lower Body - Strength': 'Legs today, going heavy. Heavy lower body work carries further than almost anything else you do - you feel it in how you stand, how you carry groceries, how you recover from the rest of the week. Warm up properly and don\'t rush the sets.',
  ...
  'Upper Body - Volume': 'Upper body with more sets and variety. Women tend to underdo this work, and it shows up in how their shoulders and back feel after a few weeks of doing more of it.',
  ...
  'Pull - Back & Biceps': 'Everything today involves pulling - back and biceps. Back training is the thing women tend to get the least of, and it makes a bigger difference than people expect. Better posture, stronger shoulders, more shape. Your biceps will get plenty of work just from the back exercises.',
  ...
  'Legs - Quads & Glutes': 'Leg day, with more focus on the front of your legs and your glutes. The glutes are the biggest muscle in the body - when you train them heavy, you feel it outside the gym as much as in it.',
  ...
  'Shoulders & Upper Back': 'Shoulder and upper back day together. These muscles hold your posture together under load and take most of the strain out of daily carrying and pressing.',
  ...
  'Legs - Posterior': 'Hamstrings and glutes. Deadlift variations and hip thrusts. These movements can feel less natural than squatting at first, but they\'re where a lot of the real strength comes from.',
  ...
  'Press Focus': 'Pressing movements are the priority today. Bench or overhead press, done properly with real effort. Pressing heavy tends to carry over into almost everything else you train.',
