...
export const EXERCISE_LIBRARY: Exercise[] = [
  ...
  {name:"Calf Raises",muscle:"legs",equip:["machines","dumbbells"],tags:["Isolation"],logType:"weighted"},
  ...
  {name:"Glute Bridge",muscle:"hinge",equip:["barbell","dumbbells"],tags:["Compound"],logType:"weighted"},
